...
//背包UI系统
@ccclass
export default class bagInfo_equie extends cc.Component{
    @property(cc.RichText)
    private CName:cc.RichText;
    @property(cc.RichText)
    private item1:cc.RichText;
    @property(cc.RichText)
    private item2:cc.RichText;
    @property(cc.RichText)
    private item3:cc.RichText;
    @property(cc.RichText)
    private item4:cc.RichText;
    private data;

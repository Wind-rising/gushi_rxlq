...
@ccclass
export default class MatchCompare extends cc.Component {

    //主队队员
    private _homePlayers:Array<Object>;
    //客队队员
    ...
    public onChange(index):void{
        ...
        // }
        // for(var i:uint=0; i<PLAYER_NUM; i++){//玩家是主队
        //     player = _homePlayers[i];
        //     player.format(homeData[i], index-1);
        ...
        //     player = _awayPlayers[i];
        //     player.format(awayData[i], index-1);
